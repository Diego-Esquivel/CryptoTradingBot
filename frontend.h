 ...
 *  Portfolio Project v.0.1: - frontend.h, <iostream>, <string>, <fstream>, <sstream>
 *  Code Summary: This source code file demonstrates our class learned materail. It implements file I/O and inheritance.
 * *****************************************************************************************************************************************/
#ifndef FRONTEND_H
#define FRONTEND_H 
#include <iostream>
